...
import { MOSS_TTS_LOCAL_VOICE_CLONE_DEFAULT_PARAMS } from '@/components/moss_tts_local/voiceCloneParams';
...
const nVqForInference = computed({
  get: () => Number(props.modelValue.nVqForInference ?? MOSS_TTS_LOCAL_VOICE_CLONE_DEFAULT_PARAMS.nVqForInference),
  set: value => {
