...
$excludeExtensions = @('.pyc', '.pyo', ".gitignore")
$sourceDirectories = @('scripts')
$modelDirectories = @('qwen3_tts', 'vox_cpm2', 'moss_tts_local', 'gpt_sovits_cpufast', 'dots_tts', 'irodori_tts_v3', 'moss_tts_realtime', 'index_tts')
